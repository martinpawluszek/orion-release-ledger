      ...
      "Resolución de bugs": [
        {
          ...
          description: "Se hicieron mejoras en el código para la función de la autorenovación para hacerla más eficiente y garantizar su correcto funcionamiento para todos nuestros productos de conectividad. Los períodos de autorenovación van a depender del tipo de producto:\n\n1. Producto con duración mes calendario: Data Pool, Fixed Plan y PAYG, se renuevan mensualmente.\n\n2. Producto con duracion variable: Nuevo Flex Plan, se renueva cuando se acaban los meses asignados al plan."
        }
      ]
    }
  }
