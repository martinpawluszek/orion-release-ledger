...
const mockReleases = [
  {
    ...
    sections: {
      "Nuevas Funcionalidades": [
        {
          title: "Sección BI",
          description: "Un nuevo espacio de análisis que muestra cómo está funcionando y creciendo tu negocio, con insights que facilitan la facturación de clientes, por ejemplo:\n\n1. Comparación entre producto comprado y producto vendido\n2. Que productos tiene mayor uso\n3. Que tipo de productos tienen mayor consumo de datos\n4. Que clientes tienen mayor cantidad de SIMs activas\n5. Que productos tienen contratados cada cliente\n6. Cuales SIMs tienen productos próximos a expirar\n7. Cuales SIMs fueron activadas en el mes en curso\n8. Vigencias de los Productos Flex Plan"
        }
      ],
      "Mejoras": [
        {
        ...
        },
        {
          ...
          description: "Ahora facturamos basándose en el Tiempo de Cierre CDR en lugar del Tiempo de Apertura, para mejorar la precisión de la facturación ya que existe una latecia en la recepción de los CDRs"
        },
        {
          title: "Reglas de Cambio de Producto Simplificadas",
          description: "Reglas de cambio de producto:\n1. Cambio INMEDIATO: Para SIMs nuevas (\"Lista\") o con plan expirado (\"Suspendida\")\n    • Nota: Los planes Pay As You Go (PAYG) cambian inmediatamente, en cualquier caso\n\n2. Cambio PROGRAMADO (En Cola): Para SIMs con un plan activo. El nuevo plan se aplicará al finalizar el ciclo del actual\n\n<div class=\"my-4 overflow-x-auto\"><table class=\"w-full border-collapse\"><thead><tr class=\"bg-[#4A90E2] text-white\"><th class=\"border border-gray-300 px-3 py-2 text-left font-medium\">Si la SIM está...</th><th class=\"border border-gray-300 px-3 py-2 text-left font-medium\">Y su plan está...</th><th class=\"border border-gray-300 px-3 py-2 text-left font-medium\">El cambio será...</th><th class=\"border border-gray-300 px-3 py-2 text-left font-medium\">Y se activará...</th></tr></thead><tbody><tr class=\"bg-white\"><td class=\"border border-gray-300 px-3 py-2\">Lista</td><td class=\"border border-gray-300 px-3 py-2\">(Cualquiera)</td><td class=\"border border-gray-300 px-3 py-2\">Inmediato</td><td class=\"border border-gray-300 px-3 py-2\">Con el primer uso</td></tr><tr class=\"bg-gray-50\"><td class=\"border border-gray-300 px-3 py-2\">Suspendida</td><td class=\"border border-gray-300 px-3 py-2\">Expirado</td><td class=\"border border-gray-300 px-3 py-2\">Inmediato</td><td class=\"border border-gray-300 px-3 py-2\">Tras activación manual</td></tr><tr class=\"bg-white\"><td class=\"border border-gray-300 px-3 py-2\">Activa</td><td class=\"border border-gray-300 px-3 py-2\">Activo</td><td class=\"border border-gray-300 px-3 py-2\">Programado (en cola)</td><td class=\"border border-gray-300 px-3 py-2\">Automáticamente</td></tr><tr class=\"bg-gray-50\"><td class=\"border border-gray-300 px-3 py-2\">Suspendida (por usuario)</td><td class=\"border border-gray-300 px-3 py-2\">Activo</td><td class=\"border border-gray-300 px-3 py-2\">Programado (en cola)</td><td class=\"border border-gray-300 px-3 py-2\">Tras activación manual</td></tr></tbody></table></div>\n\nReglas para Mover SIMs entre Clientes:\n1. Movimiento con Plan Activo: Una SIM con plan activo puede moverse libremente entre clientes \"hijos\". El cargo del plan se asignará al cliente propietario al final del período de facturación\n    • Nota Importante: Al hacer el cambio entre clientes, es importante seleccionar el mismo plan que la SIM card posee para poder completar el movimiento. Si se elige un plan diferente, el mismo entrará en cola y el movimiento se realizará recién en el próximo período, una vez que el plan actual finalice\n\n2. Movimiento con Plan Expirado: Se requiere una activación manual para iniciar el nuevo ciclo para el nuevo cliente"
        }
      ],
